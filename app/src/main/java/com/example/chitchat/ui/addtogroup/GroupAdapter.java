...
public class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.GroupViewHolder> {
    ...
    public class GroupViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public GroupViewHolder( View itemView, OnClickItemEventListener onClickItemEventListener) {
            ...
            groupNameTextView = itemView.findViewById(R.id.item_addtogroup_groupname);
            groupDescriptionTextView = itemView.findViewById(R.id.item_addtogroup_groupdescription);
